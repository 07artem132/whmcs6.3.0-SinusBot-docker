...
class shipyard {
    ...
    function curlpostjson($data, $url, $autn) {
        ...
        $result = curl_exec($ch);
		logModuleCall('sinusdocker',__CLASS__ . '->' . __FUNCTION__, ['data'=>$data,'url'=>$url,'autn'=>$autn], null, $result , NULL);
        $info = curl_getinfo($ch);
		logModuleCall('sinusdocker',__CLASS__ . '->' . __FUNCTION__, null, null, $info , NULL);
	    logModuleCall('sinusdocker',__CLASS__ . '->' . __FUNCTION__, null, null, curl_error($ch), NULL);
        curl_close($ch);
