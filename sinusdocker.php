 ...
 *
 * @see sinusdocker_buttonOneFunction()
 *
 * @return array
 */
function sinusdocker_AdminCustomButtonArray() {
    return;
}
 ...
 * @return array
 */
function sinusdocker_ClientAreaCustomButtonArray() {
    return;
}
 ...
 *
 * @see http://docs.whmcs.com/Provisioning_Module_SDK_Parameters
 * @see sinusdocker_AdminCustomButtonArray()
 *
 * @return string "success" or an error message
 */
function sinusdocker_buttonOneFunction(array $params) {
    try {
 ...
 *
 * @see http://docs.whmcs.com/Provisioning_Module_SDK_Parameters
 * @see sinusdocker_ClientAreaCustomButtonArray()
 *
 * @return string "success" or an error message
 */
function sinusdocker_actionOneFunction(array $params) {
    try {
        // Call the service's function, using the values provided by WHMCS in
        // `$params`.
    } catch (Exception $e) {
 ...
 *
 * @see http://docs.whmcs.com/Provisioning_Module_SDK_Parameters
 * @see sinusdocker_AdminServicesTabFieldsSave()
 *
 * @return array
 */
function sinusdocker_AdminServicesTabFields(array $params) {
    try {
        // Call the service's function, using the values provided by WHMCS in
        // `$params`.
        $response = array();
 ...
 *
 * @see http://docs.whmcs.com/Provisioning_Module_SDK_Parameters
 * @see sinusdocker_AdminServicesTabFields()
 */
function sinusdocker_AdminServicesTabFieldsSave(array $params) {
    // Fetch form submission variables.
    $originalFieldValue = isset($_REQUEST['sinusdocker_original_uniquefieldname']) ? $_REQUEST['sinusdocker_original_uniquefieldname'] : '';

    $newFieldValue = isset($_REQUEST['sinusdocker_uniquefieldname']) ? $_REQUEST['sinusdocker_uniquefieldname'] : '';
